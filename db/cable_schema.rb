...
ActiveRecord::Schema[8.2].define(version: 20_260_417_045_233) do
  ...
  create_table 'target_domains', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[domain_id job_posting_id], name: 'index_target_domains_on_domain_id_and_job_posting_id', unique: true
    t.index ['domain_id'], name: 'index_target_domains_on_domain_id'
    t.index %w[job_posting_id domain_id], name: 'index_target_domains_on_job_posting_id_and_domain_id', unique: true
