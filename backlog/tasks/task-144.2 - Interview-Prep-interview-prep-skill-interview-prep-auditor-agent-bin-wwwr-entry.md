...
<!-- SECTION:NOTES:BEGIN -->
bin/wwwr interview-prep 7068 verified live against the real [redacted] posting -- prints the stored pack. Skill shows in the available-skills list after write.
