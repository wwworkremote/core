...
- `leadership.yml` — 3 of its 6 items are orphaned (not covered by any position file): the enterprise OpenTelemetry ownership handoff, founding Software Craftsmanship McHenry County (823 members), and founding [redacted]/WHOIS.
- `portfolio.yml` — 5 projects; [redacted], Chicago Code Camp, and UGl.st have no position file at all.
...
- [ ] #2 portfolio-only projects ([redacted], Chicago Code Camp, UGl.st) exist as WorkExperience rows or are explicitly declined
