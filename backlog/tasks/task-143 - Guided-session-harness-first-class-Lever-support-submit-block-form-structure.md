...
Surfaced 2026-08-31 applying to Basis (Sr Software Engineer, Basis Platform / DSP — Lever, JobPosting #7068 / Lead #191). Mike wanted the harness on a real Lever application; the guided session records fine but the Bounded Agency guarantee does not hold.
...
The Lever *ingestion* adapter already works (Lead #191 captured + promoted from `jobs.lever.co/basis/...`). This is about the *application/guided-session* side only.
