<!-- ═══════════════════════════════════════════════════════════════════════
  ...
  ★ TOP PRIORITY — TASK-150: prepare this repo to go PUBLIC.
     ...
     interview (company "Example", referrer "Example", the Lever URL, dates).
  ...
  Example: Round 1 advanced; Round 2 scheduled for Tuesday, Sep 8, 2026 at 10:00 AM CDT
  ...
  Done 2026-09-06 session 7 (main):
    ...
    - Updated Example role: Round 1 outcome marked advanced; Round 2 scheduled
